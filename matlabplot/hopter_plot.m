function hopter_plot(t,states)
    ...
    ax.TickLabelInterpreter = "latex";
    ax.FontSize = 20;
    ylabel('$\theta_{\mathcal{Q}} \rm{[deg]}$','Interpreter','latex','FontSize',20);
    ...
    ax.TickLabelInterpreter = "latex";
    ax.FontSize = 20;
    ylabel('$\phi_{\mathcal{Q}} \rm{[deg]}$','Interpreter','latex','FontSize',20);
    ...
    ax.FontSize = 20;
    xlabel('$t\rm{[s]}$','Interpreter','latex','FontSize',20);
    ylabel('$\psi_{\mathcal{Q}} \rm{[deg]}$','Interpreter','latex','FontSize',20);
